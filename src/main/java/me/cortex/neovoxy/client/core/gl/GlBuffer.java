...
public class GlBuffer implements AutoCloseable {
    ...
    /**
     * Upload data from an IntBuffer to a subregion.
     */
    public void upload(long offset, java.nio.IntBuffer data) {
        glNamedBufferSubData(id, offset, data);
    }

    /**
     * Upload data from a LongBuffer to a subregion.
     */
    public void upload(long offset, java.nio.LongBuffer data) {
        glNamedBufferSubData(id, offset, data);
    }
