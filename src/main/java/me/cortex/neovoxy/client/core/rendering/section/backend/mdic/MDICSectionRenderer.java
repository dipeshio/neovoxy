 ...
 * 
 * <p>Uses glMultiDrawElementsIndirectCount for efficient batched rendering
...
public class MDICSectionRenderer extends AbstractSectionRenderer {
    ...
    public void renderOpaque(Viewport viewport) {
        ...
        // Bind buffers
        drawCommandBuffer.bindBase(GL_SHADER_STORAGE_BUFFER, 1);
        drawCountBuffer.bindBase(GL_SHADER_STORAGE_BUFFER, 2);
        sectionBuffer.bindBase(GL_SHADER_STORAGE_BUFFER, 3);
        modelStore.bind(4, 5);
        
        // Bind geometry quad buffer
        glBindBufferBase(GL_SHADER_STORAGE_BUFFER, 6, geometryData.getQuadBufferId());
        ...
        glMultiDrawElementsIndirectCount(
            ...
            4,                      // parameter buffer offset (skip dispatch data)
     ...
     */
    public static final Factory<MDICSectionRenderer, IGeometryData> FACTORY = 
        new Factory<>() {
            @Override
